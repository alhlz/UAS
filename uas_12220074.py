...
def biggestCumul(frommenu):
    ...
    if frommenu: # boolean buat penanda kalo ini emang dari panggilan menu
        b = int(st.text_input("Masukkan jumlah negara yang ingin ditampilkan: "))
...
def mainProgram():
    ...
    image = Image.open('Downloads/oilrig1.jpeg')
    st.image(image)
    ...
    st.title("Aplikasi Informasi Data Produksi Minyak")
    st.subheader("Selamat datang di aplikasi informasi data produksi minyak!")
